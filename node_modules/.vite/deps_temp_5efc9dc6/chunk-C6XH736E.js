...
function tag_proxy(value, label2) {
  var _a;
  (_a = value == null ? void 0 : value[PROXY_PATH_SYMBOL]) == null ? void 0 : _a.call(value, label2);
  return value;
}
...
function source(v, stack2) {
  ...
  if (true_default && tracing_mode_flag) {
    signal.created = stack2 ?? get_stack("created at");
    signal.updated = null;
...
function set(source2, value, should_proxy = false) {
  ...
  (!untracking || (active_reaction.f & EAGER_EFFECT) !== 0) && is_runes() && (active_reaction.f & (DERIVED | BLOCK_EFFECT | ASYNC | EAGER_EFFECT)) !== 0 && !((_a = current_sources) == null ? void 0 : _a.includes(source2))) {
...
function mark_reactions(signal, status) {
  ...
  for (var i = 0; i < length; i++) {
    ...
    if ((flags2 & DERIVED) !== 0) {
      ...
      (_a = batch_values) == null ? void 0 : _a.delete(derived2);
...
var _commit_callbacks, _discard_callbacks, _pending2, _blocking_pending, _deferred, _dirty_effects, _maybe_dirty_effects, _Batch_instances, traverse_effect_tree_fn, defer_effects_fn, resolve_fn, commit_fn;
var _Batch = class _Batch {
  ...
  flush() {
    ...
    } else if (__privateGet(this, _pending2) === 0) {
      this.process([]);
    }
    this.deactivate();
  }
   ...
   */
  increment(blocking) {
    __privateSet(this, _pending2, __privateGet(this, _pending2) + 1);
...
resolve_fn = function() {
  ...
  if (__privateGet(this, _pending2) === 0) {
...
function get(signal) {
  ...
  if (true_default) {
    ...
    if (tracing_mode_flag && !untracking && tracing_expressions !== null && active_reaction !== null && tracing_expressions.reaction === active_reaction) {
      if (signal.trace) {
        ...
        var trace2 = get_stack("traced at");
        if (trace2) {
  ...
  if (is_destroying_effect) {
    ...
    signal;
    if ((_b = batch_values) == null ? void 0 : _b.has(derived2)) {
  ...
  } else if ((_c = batch_values) == null ? void 0 : _c.has(signal)) {
...
function proxy(value) {
  ...
  var version = state(0);
  var stack2 = true_default && tracing_mode_flag ? get_stack("created at") : null;
...
//# sourceMappingURL=chunk-C6XH736E.js.map
